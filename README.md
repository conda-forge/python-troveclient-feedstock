...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-troveclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12764&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-troveclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-troveclient` can be installed with:

```
conda install python-troveclient
```

It is possible to list all of the versions of `python-troveclient` available on your platform with:
